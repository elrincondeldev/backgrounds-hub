...
export const MinimalLight = () => {
  return (
    <div className="absolute inset-0 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem] -z-10">
...
export const MinimalLightWithNoise = () => {
  return (
    <div className="absolute inset-0 h-full -z-10 w-full bg-[#fafafa] [background-image:url('data:image/svg+xml;base64,')]" />
  );
};

export const MinimalLightGradient = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-gradient-to-br from-[#fafafa] to-[#f0f0f0]" />
  );
};

export const MinimalLightSpotlight = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-[#fafafa]">
...
export const MinimalDarkGrid = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-[#0a0a0a]">
...
export const MinimalGradientSubtle = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-gradient-to-br from-white to-[#f5f5f5]" />
  );
};
...
export const SoftGradientBlue = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-gradient-to-br from-blue-50 to-white" />
  );
};

export const SoftGradientGray = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-gradient-to-br from-gray-50 to-white" />
  );
};
...
export const MinimalLightGrid = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]">
      <div className="absolute bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_800px_at_100%_200px,#d5c5ff,transparent)]"></div>
    </div>
  );
};
...
export const AuroraBorealis = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-slate-900 overflow-hidden">
...
export const CrystalMorphism = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-gradient-to-br from-white/40 to-white/10 backdrop-blur-xl">
...
export const LiquidGradient = () => {
  return (
    <div className="absolute -z-10 inset-0 h-full w-full bg-gradient-to-br from-violet-500 to-indigo-500">
...
export const GradientWaves = () => {
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-gradient-to-br from-rose-100 to-teal-100">
...
export const PastelMesh = () => {
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-gradient-to-br from-pink-50 to-purple-50">
